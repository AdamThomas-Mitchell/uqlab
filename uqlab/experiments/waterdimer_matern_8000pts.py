...
results_df_GP.to_csv('waterDimer_GP_matern_8000pts_results.csv')
recal_df_GP.to_csv('waterDimer_GP_matern_8000pts_recal.csv')
results_df_TP.to_csv('waterDimer_TP_matern_8000pts_results.csv')
recal_df_TP.to_csv('waterDimer_TP_matern_8000pts_recal.csv')
