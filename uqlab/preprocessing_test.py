...
class GlycineDataLoaderTest(DataLoader):
    def __init__(self, train_prop, scale_output=True, as_tensor=True, random_state=None):

        super(GlycineDataLoaderTest, self).__init__(scale_output, as_tensor, random_state)
...
class WaterDimerDataLoaderTest(DataLoader):
    def __init__(self, n_train, n_cal, n_test, scale_output=True, as_tensor=True, random_state=None):
        super(WaterDimerDataLoaderTest, self).__init__(scale_output, as_tensor, random_state)
